        ...
        <div className="container py-5">
            <div className="row">
                ...
                <div className="col text-center text-lg-start">
                    <h1>Dhaval Vadalia</h1>

                    <p className="lead">Software development student at SAIT (Southern Alberta Institute of Technology).</p>

                    <ul className="list-inline">
                        <li className="list-inline-item my-2"><a href="mailto:dhavalvadalia64@gmail.com" className="fs-5 link-light text-decoration-none"><i
                        ...
                        <li className="list-inline-item my-2"><a href="https://www.linkedin.com" className="fs-5 link-light text-decoration-none"><i
                                ...
                                LinkedIn</a></li>
                        <li className="list-inline-item my-2"><a href="https://github.com/DhavalVadalia" className="fs-5 link-light text-decoration-none"><i
